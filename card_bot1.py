...
bot = TeleBot(token='6264570154:AAG-1iZ4GtBoO_I8BXWKTkPf2DrHf6VkPB8', parse_mode='html') # создание бота
...
card_type_keybaord.row(
    types.KeyboardButton(text='Создатель https://t.me/bebop71')
)
...
def message_handler(message: types.Message):
    ...
    if message.text == 'VISA':
        ...
        card_type = 'maestro'
        elif message.text == 'Пропродитель)':
        bot.send_message = 'https://t.me/bebop71'
